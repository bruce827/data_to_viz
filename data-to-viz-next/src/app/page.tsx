    ...
    <main className="flex min-h-screen flex-col items-center p-4 md:p-8 bg-white font-sans">
      <div className="z-10 max-w-7xl w-full flex flex-col items-center mb-8 md:mb-12">
        ...
        <p className="text-base md:text-lg text-slate-500 mb-8 max-w-2xl text-center px-4">
          What kind of data do you have? Pick the main type below, and let the decision tree guide you toward the perfect graphic.
        </p>
        
        <Tabs defaultValue="num" className="w-full max-w-4xl" onValueChange={setActiveTab}>
          <TabsList className="grid w-full grid-cols-3 lg:grid-cols-6 h-auto p-1 bg-slate-100/80 rounded-xl mb-8">
            ...
            <TabsTrigger value="relationnal" className="py-2.5 text-xs md:text-sm font-medium data-[state=active]:bg-white data-[state=active]:shadow-sm rounded-lg transition-all">互联网</TabsTrigger>
